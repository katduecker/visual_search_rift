...
% Test blanket inhibition hypothesis.
...
for s = 1:length(subj)
    ...
    glm_alpha = corrT; 
    glm_alpha.avg(:,1) = T_alpha_z_H2;
    glm_alpha_tot = corrT;
    glm_alpha_tot.avg(:,1) = T_alpha_tot_z_H2;
    glm_subj_alpha{s} = glm_alpha;
    glm_subj_alpha_tot{s} = glm_alpha_tot;
    
    soi_alpha_tot{s} = glm_alpha_tot.label(T_alpha_tot_z_H2 > 0);
...
print(fig,fullfile(plotpth,['topdown_glm_single_subj_',which_set]),'-dsvg')
print(fig,fullfile(plotpth,['topdown_glm_single_subj_', which_set]),'-dpng')
...
print(fig,fullfile(plotpth,['topdowm_glm_coh_MEGGRAD_', which_set]),'-dsvg')
print(fig,fullfile(plotpth,['topdown_glm_coh_MEGGRAD_', which_set]),'-dpng')
