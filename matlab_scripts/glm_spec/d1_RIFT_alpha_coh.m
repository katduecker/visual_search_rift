...
function c1_RIFT_alpha_coh(s, which_set)
...
num_perm = 1000;
T_alpha_H1_perm = zeros(num_perm,length(coh_T.label));
T_alpha_H2_perm = T_alpha_H1_perm;

T_alpha_tot_H1_perm = T_alpha_H1_perm;
T_alpha_tot_H2_perm = T_alpha_H1_perm;
...
T_alpha_z_H1 = (T_alpha_H1' - mean(T_alpha_H1_perm))./std(T_alpha_H1_perm);
T_alpha_z_H2 = (T_alpha_H2' - mean(T_alpha_H2_perm))./std(T_alpha_H2_perm);
