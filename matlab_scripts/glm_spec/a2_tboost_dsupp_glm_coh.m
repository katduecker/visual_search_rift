...
for s = 1:length(subj)
    ...
    load(fullfile(outpth,subj{s},['glm_coh_TvsD_',which_set,'.mat']),'coh_RIFT')
...
save(fullfile(outpth,['fig3_tboost_dsuppr_cluster_coh_',which_set,'.mat']),'statT','statD')
...
print(fig, fullfile(pth,'results','meg','9 GLM', 'glm spec quinn et al',['tboost_dsuppr_coh_', which_set]),'-dsvg')
